...
local positions = {
    ...
    Vector3.new(97343482.99, 334334434.21, -764343440.42),
    Vector3.new(6173434408.19, 1993434359.44, 3534434913.78),
    Vector3.new(123434793.66, 194343416.05, 596634347.36)
}
